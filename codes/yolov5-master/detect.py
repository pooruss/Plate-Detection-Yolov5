...
from utils.plots import plot_one_box, plot_mosaic2
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        # plot_mosaic2(xyxy, im0, neighbor=10)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='plate/weights/best2.pt', help='model.pt path(s)')
